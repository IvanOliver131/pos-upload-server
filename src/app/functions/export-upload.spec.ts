...
describe('export uploads', () => {
  it('should be able to export the uploads', async () => {
    // spy / stub
    // spy monitora que algo foi executado
    // stub quando eu quero modificar o comportamento de algo
    const uploadStub = vi
    ...
    const generatedCSVStream = uploadStub.mock.calls[0][0].contentStream // primeira vez q foi chamada e primeiro parametro
